...
/**
 * Set of files used for SCM operations. Consists of the base directory of the files and a list of files relative to
 * that directory.
 *
...
public class ScmFileSet implements Serializable {
	...
	private boolean containsCustomExcludes = false;
	 ...
	 * @param excludes Ant pattern for files to exclude, if null DEFAULT_EXCLUDES is used, else DEFAULT_EXCLUDES is
	 *            added.
	...
	public boolean containsCustomExcludes() {
		return containsCustomExcludes;
	}
}
