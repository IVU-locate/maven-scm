...
public class SvnDiffCommand extends AbstractDiffCommand implements SvnCommand {
	...
	protected DiffScmResult executeDiffCommand(ScmProviderRepository repo, ScmFileSet fileSet,
		...
		Commandline cl = createCommandLine((SvnScmProviderRepository) repo, fileSet, startVersion, endVersion);
	...
	public static Commandline createCommandLine(SvnScmProviderRepository repository, ScmFileSet fileSet,
		...
		if (fileSet.containsCustomExcludes() || !StringUtils.isEmpty(fileSet.getIncludes())) {
